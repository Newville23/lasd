...
CREATE  TABLE IF NOT EXISTS `lasd3`.`Curso` (
  ...
  `Profesor_derector_grupo_identificacion` BIGINT(20) NULL DEFAULT NULL ,
  `Institucion_rut` BIGINT(20) NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `lasd3`.`Clase` (
  ...
  `Curso_Institucion_rut` BIGINT(20) NOT NULL ,
  ...
  INDEX `fk_Clase_Curso1_idx` (`Curso_codigo` ASC, `Curso_Institucion_rut` ASC) ,
  ...
  CONSTRAINT `fk_Clase_Curso1`
    FOREIGN KEY (`Curso_codigo` , `Curso_Institucion_rut` )
