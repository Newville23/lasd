				...
				<div class="">
					<div class="media">
						...
						<div class="media-body">
					   		<h4 class="media-heading text-success">Ing. Lady Diana Oñate Vega</h4>
					   		<p>Profesora.</p>
						</div>
					</div>
				</div>
			...
			<div class="row-fluid bloquePegadoDown">
				<div class="tabbable">
					...
					<ul class="nav nav-tabs">
					 	<li class=""><a href="#tab1" data-toggle="tab">Contenido</a></li>
						<li class="active"><a href="#tab2" data-toggle="tab">Foro</a></li>
						<li class=""><a href="#tab3" data-toggle="tab">Trabajos</a></li>
						<li class=""><a href="#tab4" data-toggle="tab">Notas</a></li>
					</ul>
					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="tab2">
							<div class="well" id="foro">
								<ul>
									<li>
										<div class="media well well-white well2">
									  		<a class="pull-left" href="#">
									    		<img class="media-object img-polaroid" data-src="holder.js/64x64" alt="64x64" style="width: 46px; height: 46px;" src="data:image/png;base64,">
									  		</a>
									  		<div class="media-body">
									    		<h5 class="media-heading text-info"><a href="#myModal" title="first tooltip" data-toggle="modal">Titulo del foro</a></h5>
									    		<p>
									    			<span class="voto">1</span> 
									...
									<li>
										<div class="media well well-white well2">
									  		...
									  		<div class="media-body">
									    		<h5 class="media-heading text-info"><a href="#" title="first tooltip">Titulo del foro</a></h5>
									    		<p>
									    			<span class="voto">1</span> 
									    			<span class=""><i class="icon-heart"></i></span>
									    			<span class="inforo"> hace 2 días por <a href="#">Juanita</a></span>
