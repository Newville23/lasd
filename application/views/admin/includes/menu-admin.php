<ul class="list-unstyled">
	...
	<li class="<?php if ($active == 6) {echo 'active';} ?>" ><a href="<?php echo site_url('admin/estadisticas'); ?>"><i style="padding-right: 8px" class="icon-bar-chart icon-large"></i> Estadisticas</a></li>
