<ul class="unstyled">
	...
	<li class="<?php if ($active == 4) {echo 'active';} ?>" ><a href="#"><i style="padding-right: 8px" class="icon-th-list icon-large"></i> Propiedad</a></li>
	...
	<li class="<?php if ($active == 7) {echo 'active';} ?>" ><a href="#"><i style="padding-right: 8px" class="icon-picture icon-large"></i> Propiedad</a></li>
</ul>