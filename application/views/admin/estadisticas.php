<div class="container" style="margin-top: 5%;">
	<div class="row">
		...
		<div class="col-md-10 col-md-offset-2">
				...
				<div class="bloquePegadoDown" style="border-radius: 6px">
						...
						<div class="col-md-6 margen-bottom">
							<form class="">
								<div class="input-group pull-right">
									<input type="search" class="form-control" placeholder="Buscar estadisticas">
					...
					<div class="row">
						<div class="col-md-2">
							...
							<ul class="nav nav-pills nav-stacked">
							  ...
							  <li class=""><a href="#Materias" data-toggle="tab">Materias</a></li>
							...
							<div class="tab-content">
							  <div class="tab-pane" id="home">
							  		<div id="containerhome" style="min-width: 50%; height: 400px; margin: 0 auto"></div>
							  		 voluptates sequi praesentium atque recusandae enim debitis tempora quod quas ipsa dignissimos architecto deserunt exercitationem tempore odit!
							  </div>
							  <div class="tab-pane" id="Materias">
									<div id="containerMaterias" style="min-width: 50%; height: 400px; margin: 0 auto"></div>
							  		ctus possimus corporis aut et veniam adipisci debitis nesciunt rem provident distinctio quaerat deserunt quibusdam cum exercitationem nam.
							  </div>
							  <div class="tab-pane active" id="Inasistencias">
									<div id="containerInasistencias" style="min-width: 50%; height: 400px; margin: 0 auto">
							  ...
							  <div class="tab-pane" id="settings">
							  		fuga iusto cum cumque reiciendis reprehenderit recusandae nulla unde consequatur omnis vitae ullam saepe vero labore error.
							  </div>
							</div>
						</div>
					</div>
