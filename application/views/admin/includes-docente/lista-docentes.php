<div class="media well-white bloque-top marcador-borde-azul" style="margin: 0px;">
	...
	<div class="media-body">
		...
		<div class="span5" style="border-bottom: solid 3px #dadada;">
			<div class="row-fluid">
				<div class="span6"><span class="muted">Cedula: </span>823455345</div>
				<div class="span6"><span class="muted">Profesión: </span>Lic. Artes del kung fu</div>
			</div>
		</div>
